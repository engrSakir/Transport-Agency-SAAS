                            ...
                            <div class="row p-t-20">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="amount" name="amount" class="form-control bg-success text-white" placeholder="5500" required value="{{ old('number') }}">
                                        @error('amount')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="payment_method" name="payment_method" class="form-control bg-success text-white" placeholder="নগদ" required value="{{ old('method') }}">
